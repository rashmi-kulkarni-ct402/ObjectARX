// Exercise12_UserInputAndSingleLineTextObjects.cpp : Defines the initialization routines for the DLL.
//
...
extern "C" AcRx::AppRetCode acrxEntryPoint(AcRx::AppMsgCode Msg, void* pkt)
{
	...
	case AcRx::kInitAppMsg:
		...
		acutPrintf(L"\nLoading project...\n");
		acedRegCmds->addCommand(_T("AUCommands"), _T("userInput"), _T("userInput"),
			ACRX_CMD_MODAL, userInput);
		break;
